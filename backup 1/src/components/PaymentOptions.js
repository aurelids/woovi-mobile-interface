...
import { Container, Typography, RadioGroup, FormControlLabel, Radio, Box } from '@mui/material';
...
const StyledFormControlLabel = styled(FormControlLabel)(({ isFirst, isSecond, isSeventh, isSelected }) => ({
